...
option_list = list(
	...
	make_option(c("-p", "--out_prefix"), type="character", default="NA", help="prefix of output file (Required)", metavar="filename"),
	make_option(c("-e", "--out_ext"), type="character", default=".tr", help="extension of output file", metavar="filename")
); 
...
# title of .tsv
out_tsv <- paste0(opt$out_prefix, opt$out_ext)
